...
public interface CommentDao {
  ...
  int countRep(Integer cno) throws Exception // T selectOne(String statement)
  ;
  ...
  List<CommentDto> selectRep(Integer cno) throws Exception // List<E> selectList(String statement)
  ;
