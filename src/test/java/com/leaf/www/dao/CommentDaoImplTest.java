...
public class CommentDaoImplTest {
  ...
  public void delete() throws Exception {
    commentDao.deleteAll(1);
    CommentDto commentDto = new CommentDto(1, 0, "comment", "leaf");
...
//    commentDao.deleteAll(1);
    CommentDto commentDto = new CommentDto(435, 0, "121comment", "leaf");
    assertTrue(commentDao.insert(commentDto)==1);
    assertTrue(commentDao.count(435)==4);

    commentDto = new CommentDto(435, 0, "123commentww", "leaf");
    assertTrue(commentDao.insert(commentDto)==1);
    assertTrue(commentDao.count(435)==5);
  }
  ...
  public void selectAll() throws Exception {
    ...
    commentDto = new CommentDto(1, 0, "comment", "leaf");
    assertTrue(commentDao.insert(commentDto)==1);
